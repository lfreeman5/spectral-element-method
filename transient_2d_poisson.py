...
from sem_utils import construct_ax_matrix_2d, construct_ay_matrix_2d, construct_load_matrix_2d, construct_m_matrix_2d, modify_A_b_dirichlet_2D, \
    map_4d_to_2d, map_2d_to_1d, map_1d_to_2d
import sympy as sp
import time
...
def backward_euler_step(N,Ax,Ay,M,f,u_0,BCs,dt):
    '''
    ...
    '''
    LHS_matrix = map_4d_to_2d(M/dt + Ax + Ay, N)
...
def transient_solution(f,N,u0,bcs,dt,t_f):
    '''
    ...
    for i, t in enumerate(times[:-1]):
        ...
        U[i+1,:,:] = backward_euler_step(N,Ax,Ay,M,f_arr,U[i,:,:],bcs,dt)
...
if __name__ == '__main__':
    ...
    U_solution, times = transient_solution(f, N, u_0, bcs, dt, tf)
