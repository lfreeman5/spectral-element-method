...
%
%     This uses the fast evaluation scheme suggested by James Lottes,
%     which has the same complexity as barycentric interpolation without
%     the need to guard aginst divide-by-zero
%
